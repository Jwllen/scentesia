...
export function OrganicBackground() {
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uZoom: { value: 0.7 },
        uColor1: { value: new Float32Array(hexToRgb('#1e4050')) },
        uColor2: { value: new Float32Array(hexToRgb('#0a1018')) },
        uColor3: { value: new Float32Array(hexToRgb('#101c26')) },
      },
    })
  ...
  return (
    <div
      ref={containerRef}
      className="fixed inset-0 z-0 pointer-events-none overflow-hidden bg-fullscreen"
      aria-hidden="true"
    />
  )
}
